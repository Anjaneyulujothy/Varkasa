...
public   class UsersActivity extends AppCompatActivity {
    ...
    public static class UsersViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDisplayName(String name){
            ...
            TextView userNameView = (TextView) mView.findViewById(R.id.usersname);
        ...
        public void setUserStatus(String status){
            ...
            TextView userStatusView = (TextView) mView.findViewById(R.id.usersstatus);
        ...
        public void setUserImage(String thumb_image, Context ctx){
            ...
            Picasso.with(ctx).load(thumb_image).placeholder(R.drawable.saquib).into(userImageView);
